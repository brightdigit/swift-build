...
| `android-sdk-id` | Identifier for the custom Android SDK | `null` | `swift-6.4.x-DEVELOPMENT-SNAPSHOT-2026-06-15-a_android` | The `swift sdk` id the bundle registers under | **Android builds only** - Maps to `custom-sdk-id`. Required alongside `android-sdk-url` |
