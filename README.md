...
| `cache-avd` | Cache the Android AVD emulator snapshot | `true` | `false` | `true`, `false` | **Android builds only** - set `false` to skip caching the ~1GB AVD snapshot and save Actions storage |
